...
st.write("พนักงานบอกว่าบุฟเฟ่ต์ยุ่งทุกวันจนไม่ยั่งยืน ข้อมูล 5 วันพิสูจน์ได้ดังนี้")

col1, col2, col3 = st.columns(3)
col1.metric("In-house เฉลี่ยต่อวัน", "55 คน")
col2.metric("Walk-in สูงสุด", "115 คน", delta="วัน 153")
col3.metric("Walk-in ต่ำสุด", "49 คน", delta="วัน 133")
